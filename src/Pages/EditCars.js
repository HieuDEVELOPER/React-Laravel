...
const EditCar = ({
  ...
  const onChangeDesc = (event) => {
    setEditCarData((previousState) => {
      return { ...previousState, make: event.target.value };
    });
    console.log(editCarData);
  };
      ...
      <Modal isOpen={editmodal} toggle={toggleEditModal}>
        ...
        >
          ...
          <ModalBody>
            ...
            <FormGroup>
              <Label for="make">decription</Label>
              <Input
                id="make"
                name="make"
                onChange={onChangeDesc}
                value={editCarData.make ? editCarData.make : ""}
              />
            </FormGroup>
            <FormGroup>
              ...
              <Input
                ...
                value={editCarData.make ? editCarData.produced_on : ""}
              />
            </FormGroup>
            <FormGroup>
              ...
              <img
                ...
                src={`http://localhost:8000/image/${editCarData.image}`}
              />
            </FormGroup>
          </ModalBody>
          <ModalFooter>
